...
\begin{table}[H]
	...
	\begin{tabular}{|c|c|c|}
		...
		\hline
	\end{tabular}
	\caption[Genome size statistics]{Genome size statistics.}
	\label{table:genome_size_stats}
\end{table} 

The next obvious observation is that of the remaining conditions, only the \textit{selection up} condition seems to have made much of a significant change, again however with an increase of 11\%. Also noteworthy is that the mutation down condition appears to have had a steady increase in the number of base pairs until a maximum of just over 14,000 around generation 350,000 before having a fairly sharp decline back to nearly the original size. 

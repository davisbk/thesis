...
%TODO Fix up this section with the new graphic!
...
Figure~\ref{fig:mean_fitness_all_seeds} shows the population mean fitness for all seeds, as well as the average across all seeds, for each condition. 

\begin{figure}[H]
	\includegraphics[width=\linewidth]{global_fitness_all_seeds}
	\caption[Fitness all seeds all conditions]{Mean population fitness for each condition, all seeds}

...
Lastly, looking at just the last 50,000 generations in Figure~\ref{fig:genome_size_last_50k} and the respective statistics in Table~\ref{table:genome_size_stats_last_50k}, it becomes clear that, with the exception of the $N_-$ condition, the genome sizes did not generally differ much across the conditions.
\begin{figure}[H]
	\centering
...
\begin{table}[H]
	...
	\begin{tabular}{|c||c|c|c|c|c|c|}
		...
		\hline 
		Genome Size & \cellcolor{green} - & \cellcolor{red} + & \cellcolor{green} + & \cellcolor{green} - & - & \cellcolor{green} + \\
		\hline
		Fitness & \cellcolor{green} + & \cellcolor{green} - & \cellcolor{red} + & \cellcolor{red} - & + & \cellcolor{green} - \\
		\hline
		Amount of non-coding DNA & \cellcolor{green} - & \cellcolor{red} + & \cellcolor{green} + & \cellcolor{green} - & - & \cellcolor{green} + \\
		\hline
		Number of genes & \cellcolor{red} - & \cellcolor{green} + &\cellcolor{green} + & \cellcolor{green} - & - & \cellcolor{green} + \\
		\hline
		Average size of genes & \cellcolor{red} - & \cellcolor{green} + & \cellcolor{green} - & \cellcolor{red} + & - & \cellcolor{red} + \\
		\hline
		Robustness & \cellcolor{green} - &\cellcolor{green} + & \cellcolor{green} - & \cellcolor{green}+ & - & \cellcolor{red} + \\
		\hline
		Evolvability &\cellcolor{green} + &\cellcolor{green} - & \cellcolor{red}  + & \cellcolor{red} - & - & \cellcolor{green} + \\
		\hline		
	\end{tabular}

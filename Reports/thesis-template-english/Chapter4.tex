...
Confirming the work of Batut et al.~\cite{Batut.2014}, the increased $N_e$ allowed the efficacy of selection to increase, removing deleterious mutations from the genome, removing non-coding DNA (Figure~\{fig:pop_up:perc_non-coding}). 
...
\begin{figure}[H]
	...
	\label{fig:pop_up:perc_non-coding}
\end{figure}
